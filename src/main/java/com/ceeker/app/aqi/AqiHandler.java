...
import static com.ceeker.app.aqi.Consts.DATA_FILES;
...
public class AqiHandler {
    ...
    public AqiHandler(ConfigManager configManager) {
        ...
        this.dataFiles = configManager.getDataFiles(DATA_FILES);
    }
    ...
    public void handleDataFiles() {
        ...
        for (File dataFile : dataFiles) {
            ...
            String filePath = this.getClass().getClassLoader().getResource("data/" + DATA_FILES).getFile();
